      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
              ...
              {socials.map((social) => {
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    title={social.label}
                    className="w-9 h-9 rounded-lg glass border border-white/8 flex items-center justify-center text-white/40 hover:text-[#C9A84C] hover:border-[#C9A84C]/30 transition-all duration-200"
                  >
                    <Icon size={15} />
                  </motion.a>
                );
          ...
          <div className="md:col-span-3 md:col-start-7">
            <h4 className="text-white/50 text-xs font-semibold tracking-[0.15em] uppercase mb-5">
              Navigation
            </h4>
          ...
          <div className="md:col-span-3 md:col-start-10">
            ...
            <div className="space-y-3">
              <a
                href="mailto:contact@sosjournal.com"
                className="flex items-center gap-2.5 text-white/40 hover:text-[#C9A84C] text-sm transition-colors group"
              >
                <Mail size={14} className="text-[#C9A84C]/50 group-hover:text-[#C9A84C]" />
              ...
              <a
                ...
                className="flex items-center gap-2.5 text-white/40 hover:text-[#C9A84C] text-sm transition-colors group"
              >
                <Send size={14} className="text-[#C9A84C]/50 group-hover:text-[#C9A84C]" />
                Telegram
              </a>
              <a
                href="https://twitter.com/sosjournal"
                ...
                className="flex items-center gap-2.5 text-white/40 hover:text-[#C9A84C] text-sm transition-colors group"
              >
                <Twitter size={14} className="text-[#C9A84C]/50 group-hover:text-[#C9A84C]" />
                Twitter / X
              </a>
            </div>
          </div>
